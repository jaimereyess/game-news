...
export const Playstation = () => {
  return (
    <main>
      <div className="h-full min-h-screen p-2 bg-slate-900">
        <NavBar />
        <div className="container mx-auto p-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {psControllers.map((controller, index) => (
              <div key={index} className="bg-gray-200 p-4 rounded-lg">
                ...
                <p>
                  <strong>Color:</strong> {controller.color}
                </p>
                <p>
                  <strong>Price:</strong> {controller.price}
                </p>
              </div>
            ))}
          </div>
          ...
          {/* PlayStation VR2 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2 text-blue-200">
            PlayStation VR2
          </h2>
          <div className="bg-gray-200 p-4 rounded-lg">
            ...
            <p>
              <strong>Compatibility:</strong> {psVR2.compatibility}
            </p>
            <p>
              <strong>Price:</strong> {psVR2.price}
            </p>
          </div>
        </div>
      </div>
